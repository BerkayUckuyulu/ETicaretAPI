...
namespace ETicaretAPI.Persistance.Migrations
{
    ...
    [Migration("20230131220544_mig_10")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETİcaretAPI.Domain.AppRole", b =>
                {
            ...
            modelBuilder.Entity("ETİcaretAPI.Domain.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ETİcaretAPI.Domain.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ETİcaretAPI.Domain.AppUser", null)
                        .WithMany()
